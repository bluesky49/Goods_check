let global_media_height = 480, global_media_width = 640, init_global_height = 480;
...
function loadmoreCategories() {
    let cate = document.getElementById("category"),
        ...
        cntCateStyleTop = cate.style.top;
    ...
    // menu.style.bottom = Math.abs(parseInt(cntCateStyleTop) - parseInt(cate.style.top)) + parseInt(menu.style.bottom) + "px";
    menu.classList.add("hide"); menu.classList.remove("show");
    cates.classList.remove("categories"); cates.classList.add("flex-categories");

    hide("loadupdiv"); show("loadmorediv");
}
...
function initialCategories() {
    ...
    cate.style.top = parseInt(parentdiv.style.height) - parseInt(cate.style.height) + "px";
    // menu.style.bottom = parseInt(menu.style.bottom) - Math.abs(parseInt(cntCateStyleTop) - parseInt(cate.style.top)) + "px";
    menu.classList.remove("hide"); menu.classList.add("show");
    cates.classList.add("categories"); cates.classList.remove("flex-categories");

    hide("loadmorediv"); show("loadupdiv");
}
...
function setColorbtn(index) {
    ...
    for (let i = 1; i <= btnnames.length; i++) {
        if(i == index) {
            // document.getElementById("btn"+i).classList.remove("unsetbtn");
            // document.getElementById("btn"+i).classList.add("setbtn");
            document.getElementById("btn"+i).classList.add("active");
        } else {
            // document.getElementById("btn"+i).classList.remove("setbtn");
            // document.getElementById("btn"+i).classList.add("unsetbtn");
...
$(window).resize(function() {
    let cntW = window.innerWidth, 
        ...
        zoomRate = window.devicePixelRatio;
